...
const Hero: React.FC<HeroProps> = ({ onSearch }) => {
  return (
    <div className="relative bg-gradient-to-br from-amazon-dark via-teal-900 to-amazon-primary text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 flex flex-col items-center text-center">
        ...
        <div className="w-full max-w-xl relative">
          ...
          <input
            type="text"
            className="block w-full pl-11 pr-4 py-4 rounded-2xl border border-white/10 bg-slate-900/80 backdrop-blur-xl text-white placeholder:text-slate-400 focus:ring-2 focus:ring-amazon-accent focus:outline-none shadow-2xl transition-all"
